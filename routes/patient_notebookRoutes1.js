...
router.get("/", async (req, res) => {
    ...
    `;
        ...
        console.log("Archive Query:", queryArchive);
        console.log("Master Query:", queryMaster);
        ...
        console.log("Archive Results:", resultArchive.rows.length, "rows");
        console.log("Master Results:", resultMaster.rows.length, "rows");
