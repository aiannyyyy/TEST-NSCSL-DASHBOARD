document.addEventListener('DOMContentLoaded', function() {
    ...
    const itemThresholds = {
        'REA005': {critical: 10, warning: 12, unit:'kits'},
        'REA006': {critical: 10, warning: 12, unit:'kits'},
        'REA007': {critical: 10, warning: 12, unit:'kits'},
        'REA008': {critical: 5, warning: 7, unit:'boxes'},
        'REA019': {critical: 5, warning: 7, unit:'boxes'},
        'REA025': {critical: 10, warning: 12, unit:'kits'},
        'REA028': {critical: 2, warning: 4, unit:'kits'},
        'REA029': {critical: 1, warning: 2, unit:'box'},
        'REA030': {critical: 1, warning: 2, unit:'box'},
        'REA031': {critical: 0.25, warning: 0.50, unit:'bottle'},
        'REA032': {critical: 10, warning: 12, unit:'kits'},
        'REA033': {critical: 15, warning: 17, unit:'kits'},
        'REA036': {critical: 10, warning: 12, unit:'kits'},
        'REA051': {critical: 2 , warning: 4, unit:'bottles'},
        'REA052': {critical: 15, warning: 17, unit:'kits'},
        'REA053': {critical: 15, warning: 17, unit:'kits'},
        'REA054': {critical: 15, warning: 17, unit:'kits'},
        'REA057': {critical: 2, warning: 4, unit:'bottles'},
    }
